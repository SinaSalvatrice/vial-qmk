...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_6x4(
        ...
        LCTL(KC_Z),             LSFT(KC_HOME),          LCTL(KC_R),             LCTL(KC_C),
        LSFT(KC_LEFT),          LCTL(KC_S),             LSFT(KC_RGHT),          KC_NO,
        LCTL(LSFT(KC_LEFT)),    LSFT(KC_END),           LCTL(LSFT(KC_RGHT)),    KC_PENT,
    ...
    [2] = LAYOUT_6x4(
        ...
        LCTL(LWIN(KC_LEFT)),    KC_NO,                  LCTL(LWIN(KC_RGHT)),    KC_NO,
